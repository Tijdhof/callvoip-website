...
const renderMonthlyTotal = function () {
  ...
  const maxValue = Math.max(...['toestelaccounts', 'bellen-via-de-computer', 'bellen-met-de-smartphone-vamo-app'].map(e => document.getElementById(e).valueAsNumber)) || 1
...
const renderCallminutesFields = function (fields) {
  ...
  const numberOfDevices = document.getElementById("toestelaccounts").value,
    qallerPlus = document.getElementById("bellen-met-de-smartphone-vamo-app").value,
