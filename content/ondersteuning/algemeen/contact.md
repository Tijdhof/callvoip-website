...
{{</ layout/column2 >}}
{{</ layout/columns >}}<br>
<script src="https://www.google.com/recaptcha/enterprise.js?render=6LfrKDMsAAAAAJTc6oCQBv0vxE6Fjwt0v15WXQyQ"></script>

<script>
  function onSubmit(token) {
    // This finds the form by its ID and submits it
    document.getElementById("contactformulier").submit();
  }
</script>

<form id="contactformulier" class="mb-6" name="contactformulier" action="/contact/verzonden" accept-charset="UTF-8" method="POST" data-netlify="true">
  ...
  <p>
    <button class="button g-recaptcha" 
      data-sitekey="6LfrKDMsAAAAAJTc6oCQBv0vxE6Fjwt0v15WXQyQ" 
