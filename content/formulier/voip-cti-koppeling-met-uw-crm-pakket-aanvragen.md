...
<textarea id="opmerkingen" name="opmerkingen" class="w-full border border-grey-light bg-white  px-3 py-3 text-base" cols="30" rows="10"> placeholder="this text will show in the textarea"></textarea>
