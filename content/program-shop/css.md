...
headerside:
  ...
  btn:
    text: CSS-koppeling gratis 1 week testen?
    url: /aanvragen/voip-cti/

---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket CSS CarSys?<br>
CSS: CarSys, CRM software voor garagehouders en werkplaats**<br>
<br>
**Samenvatting**<br>
...
<li>Geen match van het telefoonnummer met een contact in CSS? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
