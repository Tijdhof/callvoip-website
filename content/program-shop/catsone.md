...
De Callvoip telefoon-integratie met CatsOne kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de CatsOne-koppeling</a></div>
