---
title: "Wij koppelen jouw CRM Microsoft Dynamics NAV aan onze telefonie"
shorttitle: "Microsoft Dynamics NAV"
date: 2021-06-03T16:52:17+05:00
logo: "/nav.png"
description: Door het koppelen van Microsoft Dynamics NAV CRM aan onze slimme telefonie werk je een stuk efficienter.
...
headerside:
  ...
  btn:
    text: Microsoft Dynamics NAV-koppeling gratis testen?
...
categories:
  ...
  - Financieel
weight: 10
url: /marketplace/microsoft-dynamics-nav/
aliases: /program-shop/microsoft-dynamics-nav/

---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket Microsoft Dynamics NAV?**<br>
**Microsoft Dynamics NAV: Een ERP-app (Enterprise Resource Planning) die helpt bij financiën, productie, klantrelatiebeheer (CRM), toeleveringsketens, analyses en elektronische handel voor kleine en middelgrote bedrijven en lokale dochterondernemingen van grote internationale groepen.**<br>
<br>
**Samenvatting**<br>
Met de Callvoip Microsoft Dynamics NAV telefoonconnector beschik je over een slimme koppeling tussen telefonie van Callvoip en Microsoft Dynamics NAV. Deze koppeling biedt een waardevolle toevoeging aan al het telefoonverkeer, zowel bij inkomende gesprekken van contacten die in Microsoft Dynamics NAV staan, als bellers die er niet instaan. Bovendien maakt de koppeling het mogelijk om elk telefoonnummer met één klik automatisch te bellen! Let maar op: al na een halve dag wil je dit gemak en comfort niet meer missen en kun je nog meer tijd besteden aan je andere werkzaamheden!<br>
<br>
**Inkomende gesprekken**<br>
Bij elke inkomende en/of uitgaande oproep verschijnt direct een pop-up in het beeldscherm van je PC met de klantinformatie vanuit Microsoft Dynamics NAVen kun je direct de klantkaart openen. De popup heeft een aantal unieke eigenschappen. <br>
<div class="usp-list">
<ul>
<li>Popup met nummer van de beller, klantgegevens uit CRM en handige gespreksduur-timer.</li>
<li>De informatie en de knoppen in de pop-up zijn volledig naar eigen wens samen te stellen.</li>
<li>Toon klantinformatie vanuit je CRM('s): dit is aanpasbaar per medewerker / functie. </li>
<li>Geen match van het telefoonnummer met een contact in Microsoft Dynamics NAV? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
...
Dankzij de connector kun je de nummers in Microsoft Dynamics NAV aanklikken en automatisch bellen. Maar het gemak is groter: elk telefoonnummer dat van een klik-en-bel-linkje (callto: en tel:) is voorzien kun je voortaan aanklikken en automatisch bellen. En elk telefoonnummer in elk willekeurig programma op je computer kun je selecteren en bellen door op F7 te klikken (Windows). <br>
Daarnaast is er voor Windows en Mac de **Remote Dialer**: een handige bureaublad-telefoon-app waar je een nummer kunt intoetsen of plakken om het direct te bellen. Tel uit je tijdwinst! <br>
<br>
**Details van de popup in combinatie met Microsoft Dynamics NAV:**<br>
...
Als gebruiker kun je de te vertonen pop-up volledig zelf ontwerpen. Gebruik daarvoor de klantgegevens uit Microsoft Dynamics NAV, zoals: <br>
• Telefoonnummer<br>
• Naam<br>
• Bedrijfsnaam<br>
<br>
...
Denk hierbij aan:<br>
• Open klant in Microsoft Dynamics NAV<br>
<br>
...
Het softwarepakket Microsoft Dynamics NAV CRM wordt gekoppeld met telefonie van Callvoip op basis van een API-koppeling.<br>
De Callvoip telefoon-integratie met Microsoft Dynamics NAV kan worden gebruikt op zowel Windows als Apple Mac.<br>
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Microsoft Dynamics NAV-koppeling</a></div>
