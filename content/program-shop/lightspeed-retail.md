---
shorttitle: "LightSpeed Retail (R-Series)"
title: "Wij koppelen jouw CRM LightSpeed Retail (R-Series) aan onze telefonie"
date: 2021-06-03T16:52:17+05:00
mobile: true
cloud: true
logo: "/ligthspeedhq_yed9tz.png"
description: Door het koppelen van LightSpeed Retail (R-Series) CRM aan onze slimme telefonie werk je een stuk efficienter.
...
categories:
  ...
  - Customerservice
weight: 10
url: /marketplace/lightspeed-retail/
aliases: /program-shop/lightspeed-retail/
headerside:
  ...
  btn:
    text: Test de LightSpeed Retail (R-Series)-koppeling 1 week gratis!
    url: /aanvragen/voip-cti/


---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket LightSpeed Retail (R-Series)?<br>
LightSpeed Retail (R-Series): CRM platform met een complete ondernemersplatform voor horeca, retail en e-Commerce wereldwijd.**<br><br>
**Samenvatting**<br>
Met de Callvoip LightSpeed Retail (R-Series) telefoonconnector beschik je over een slimme koppeling tussen telefonie van Callvoip en LightSpeed Retail (R-Series). Deze koppeling biedt een waardevolle toevoeging aan al het telefoonverkeer, zowel bij inkomende gesprekken die in LightSpeed Retail (R-Series) staan, als bellers die er niet instaan, én maakt het mogelijk om elk telefoonnummer met één klik automatisch te bellen! Let maar op: al na een halve dag wil je dit gemak en comfort niet meer missen, en kun je nog meer tijd besteden aan je échte werkzaamheden!<br>
<br>
**Inkomende gesprekken**<br>
Bij elke inkomende en/of uitgaande oproep verschijnt direct een pop-up in het beeldscherm van je PC met de klantinformatie vanuit LightSpeed Retail (R-Series) en kun je direct de klantkaart openen. De popup heeft een aantal unieke eigenschappen: <br>
<div class="usp-list">
<ul>
...
Dankzij de connector kun je de nummers in LightSpeed Retail (R-Series) aanklikken en automatisch bellen. Maar het gemak is groter: elk telefoonnummer dat van een klik-en-bel-linkje (callto: en tel:) is voorzien kun je voortaan aanklikken en automatisch bellen. En elk telefoonnummer in elk willekeurig programma op je computer kun je selecteren en bellen door op F7 te klikken (Windows). <br>
Daarnaast is er voor Windows en Mac de **Remote Dialer**: een handige bureaublad-telefoon-app waar je een nummer kunt intoetsen of plakken om het direct te bellen. Tel uit je tijdwinst!<br>
<br>
**Details van de popup in combinatie met LightSpeed Retail (R-Series):**<br>
Als gebruiker kun je de te vertonen pop-up volledig zelf ontwerpen. <br>
Je kunt dan de klantgegevens uit LightSpeed Retail (R-Series) gebruiken, denk hierbij aan gegevens zoals: <br>
...
Denk hierbij aan:<br>
• Open klant in LightSpeed Retail (R-Series)<br>
<br>
...
Het softwarepakket LightSpeed Retail (R-Series) CRM wordt gekoppeld met telefonie van Callvoip op basis van een API-koppeling.<br>
De Callvoip telefoon-integratie met LightSpeed Retail (R-Series) CRM kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de LightSpeed Retail (R-Series)-koppeling</a></div>
