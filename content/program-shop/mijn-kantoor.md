---
shorttitle: "Mijn Kantoor"
title: "Wij koppelen jouw CRM Mijn Kantoor aan onze telefonie"
date: 2021-06-03T16:52:17+05:00
logo: "/mijnkantoor_kbirgq.png"
description: Door het koppelen van Mijn Kantoor CRM aan onze slimme telefonie werk je een stuk efficienter.
...
ontwikkelaar:
  - title: Via API
url: /marketplace/mijn-kantoor/
aliases: /program-shop/mijn-kantoor/
headerside:
  ...
  btn:
    text: Mijn Kantoor-koppeling gratis 1 week testen?
    url: /aanvragen/voip-cti/

---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket Mijn Kantoors?<br>
...
<li>Geen match van het telefoonnummer met een contact in Mijn Kantoor? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
...
Dankzij de connector kun je de nummers in Mijn Kantoor aanklikken en automatisch bellen. Maar het gemak is groter: elk telefoonnummer dat van een klik-en-bel-linkje (callto: en tel:) is voorzien kun je voortaan aanklikken en automatisch bellen. En elk telefoonnummer in elk willekeurig programma op je computer kun je selecteren en bellen door op F7 te klikken (Windows). <br>
Daarnaast is er voor Windows en Mac de **Remote Dialer**: een handige bureaublad-telefoon-app waar je een nummer kunt intoetsen of plakken om het direct te bellen. Tel uit je tijdwinst! <br>
<br>
**Details van de popup in combinatie met Mijn Kantoor:**<br>
Als gebruiker kun je de te vertonen pop-up volledig zelf ontwerpen. <br>
Je kunt dan de klantgegevens uit Mijn Kantoor gebruiken, denk hierbij aan gegevens zoals: <br>
...
Het softwarepakket Mijn Kantoor CRM wordt gekoppeld met telefonie van Callvoip op basis van een API-koppeling.<br>
De Callvoip telefoon-integratie met Mijn Kantoor CRM kan worden gebruikt op zowel Windows als Apple Mac.<br>
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Mijn Kantoor-koppeling</a></div>
