...
headerside:
  ...
  btn:
    text: Microsoft Dynamics 365-koppeling gratis testen?
...
categories:
  ...
  - Embedded Popup
weight: 10
url: /marketplace/microsoft365-embedded/
aliases: /program-shop/microsoft365-embedded/

---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket Microsoft Dynamics 365?**<br>
...
Dankzij de connector kun je de nummers in Microsoft Dynamics 365 aanklikken en automatisch bellen. Maar het gemak is groter: elk telefoonnummer dat van een klik-en-bel-linkje (callto: en tel:) is voorzien kun je voortaan aanklikken en automatisch bellen. En elk telefoonnummer in elk willekeurig programma op je computer kun je selecteren en bellen door op F7 te klikken (Windows). <br>
Daarnaast is er voor Windows en Mac de **Remote Dialer**: een handige bureaublad-telefoon-app waar je een nummer kunt intoetsen of plakken om het direct te bellen. Tel uit je tijdwinst! <br>
<br>
**Details van de popup in combinatie met Microsoft Dynamics 365:**<br>
...
Als gebruiker kun je de te vertonen pop-up volledig zelf ontwerpen. Gebruik daarvoor de klantgegevens uit Microsoft Dynamics 365, zoals: <br>
• Telefoonnummer<br>
• Naam<br>
• Bedrijfsnaam<br>
<br>
...
Denk hierbij aan:<br>
• Open klant in Microsoft Dynamics 365<br>
<br>
...
Het softwarepakket Microsoft Dynamics 365 CRM wordt gekoppeld met telefonie van Callvoip op basis van een API-koppeling.<br>
De Callvoip telefoon-integratie met Microsoft Dynamics 365 kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Dynamics 365-koppeling</a></div>
