---
shorttitle: "Embedded - Salesforce"
title: "Wij koppelen jouw CRM Salesforce aan onze telefonie"
date: 2021-06-03T16:52:17+05:00
logo: "/salesforced-embedded_z7xsx1.png"
description: Door het koppelen van Salesforce Embedded popup aan onze slimme telefonie werk je een stuk efficienter.
...
categories:
  ...
  - Embedded Popup
weight: 10
url: /marketplace/salesforce-embedded/
aliases: /program-shop/salesforce-embedded/
headerside:
...
Bubble heeft een aantal unieke eigenschappen. Deze integratie zorgt ervoor dat je direct alle relevante klantgegevens in beeld krijgt bij een telefonische oproep. Vanuit het overzicht wat verschijnt, wat ook nog eens volledig naar wens van de gebruiker, afdeling of bedrijf is aan te passen, kun je direct de gewenste actie uitvoeren. De informatie die je kunt weergeven in de pop-up kun je vinden onder tab parameters en de beschikbare knoppen onder tab knoppen. Bij het doorverbinden van een gesprek naar een collega verhuist de klantinformatie mee. Standaard is de pop-up notificatie in Salesforce zichtbaar vanaf het moment dat je webcalls, bureautoestel of ander device rinkelt tot het moment dat het gesprek wordt beëindigd.<br><br>
...
<li>Geen match van het telefoonnummer met een contact in SalesForce CRM? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
...
De Callvoip telefoon-integratie met SalesForce CRM kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Salesforce-koppeling</a></div>
