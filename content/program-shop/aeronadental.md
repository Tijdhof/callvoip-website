---
shorttitle: "Aerona Dental"
title: "Wij koppelen jouw CRM Aerona Dental aan onze telefonie"
date: 2021-06-03T16:52:17+05:00
logo: "/v1756472793/AeronaDental_bcdz50.png"
description: Door het koppelen van Aerona Dental CRM aan onze slimme telefonie werk je een stuk efficienter.
...
categories:
  - Tandarts
weight: 10
url: /marketplace/aerona-dental/
aliases: /program-shop/aerona-dental/
headerside:
...
<li>Geen match van het telefoonnummer met een contact in Aerona Dental? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
...
Dankzij de connector kun je de nummers in Aerona Dental aanklikken en automatisch bellen. Maar het gemak is groter: elk telefoonnummer dat van een klik-en-bel-linkje (callto: en tel:) is voorzien kun je voortaan aanklikken en automatisch bellen. En elk telefoonnummer in elk willekeurig programma op je computer kun je selecteren en bellen door op F7 te klikken (Windows). <br>
Daarnaast is er voor Windows en Mac de **Remote Dialer**: een handige bureaublad-telefoon-app waar je een nummer kunt intoetsen of plakken om het direct te bellen. Tel uit je tijdwinst! <br>
<br>
**Details van de popup in combinatie met Aerona Dental:**<br>
Als gebruiker kun je de te vertonen pop-up volledig zelf ontwerpen. Gebruik daarvoor de klantgegevens uit Aerona Dental, zoals: <br>
...
Denk hierbij aan:<br>
• Open klant in Aerona Dental<br>
<br>
...
Het softwarepakket Aerona Dental CRM wordt gekoppeld met telefonie van Callvoip op basis van een API-koppeling.<br>
De Callvoip telefoon-integratie met Aerona Dental CRM kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Aerona Dental-koppeling</a></div>
