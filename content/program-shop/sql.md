...
headerside:
  ...
  btn:
    text: SQL-koppeling gratis 1 week testen?
    url: /aanvragen/voip-cti/

---

**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en jouw CRM-pakket gebaseerd op een SQL koppeling?**<br>
<br>
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de SQL-koppeling</a></div>
