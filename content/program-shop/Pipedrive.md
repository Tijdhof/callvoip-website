...
headerside:
  ...
  btn:
    text: Pipedrive-koppeling gratis 1 week testen?
...
<li>Geen match van het telefoonnummer met een contact in Pipedrive? Vul de informatie dan aan met de **automatische Google Number Lookup**: als Google het nummer kent wordt deze verrijkt met naam, adres, plaats en website. Zo weet je toch meer dan enkel het nummer in het display van je telefoon.</li>
...
De Callvoip telefoon-integratie met Pipedrive kan worden gebruikt op zowel Windows als Apple Mac.<br> 
...
<br><a onclick="dialog.show();" class="button" style="cursor: pointer;">Ja, ik wil meer weten over de Pipedrive-koppeling</a></div>
