...
**Welke voordelen biedt een telefoniekoppeling tussen Callvoip en CRM-pakket Bytegear?**

Met de Callvoip Bytegear-connector verschijnt er bij een inkomende en/of uitgaande oproep direct een pop-up in het beeldscherm van je PC emt 4 zelf in te stellen knoppen. Met één druk op de knop geeft open je de Bytegear eigen popup die linksonder in je scherm staat. Daarin zie je gelijk de naam van de klant staan. Klik op de Bytegear popup en in Bytegear wordt een kader geopend met daarin alle relevante patiëntgegevens en de afspraken:<br>
...
<br>
Ook verschijnt er een popup in het beeldscherm van je PC met het nummer van de beller en 4 buttons voor verdere actie. Zodra je het gesprek aanneemt verschijnt een indicator in Bytegear en kun je gelijk de klantgegevens openen. Is de klant niet bekend in Bytegear, dan vult Google waar mogelijk een naam en adres toe. <br>
<br>
