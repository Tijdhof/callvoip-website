...
<div class="mb-8 bg-white rounded-lg py-8 px-6">
  ...
  <div class="flex mb-1">
    <div class="flex-1">
      <h5 class="text-base lg:text-xl font-medium mb-2 opacity-75">4G maandabonnementen</h5>
    </div>
    <div>
