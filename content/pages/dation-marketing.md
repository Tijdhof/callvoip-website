---
title: Dation Rijlesplanner CRM + slimme telefonie
description: 'Integratie van het CRM Dation Rijlesplanner en onze telefonie: makkelijk, snel en efficiënt'
type: page
layout: default2
logos: false
url: "/crmintegratie/Dation/"
marketplaceItem: true
hero:
  title: Dation Rijlesplanner + slimme telefonie
  content: '<div class="usp-list"><ul><li>Slimme pop-up van elk gesprek</li><li>Direct
    de klantgegevens in beeld</li><li>Werk efficiënter</li></ul></div>Het CRM platform Dation Rijlesplanne is een systeem gericht op Rijschoolhouders. Meer specifiek op excellente communicatie met hun klanten. Email, chat, Whatsapp en natuurlijk hoort daar ook telefonie bij! En daar komt Callvoip om de hoek kijken: koppel jouw Dation Rijlesplanne nu aan onze telefonie en profiteer van het gemak en de efficiëntie.<br><br><a
    href="https://www.callvoip.nl/aanvragen/voip-cti/" class="button">Vraag nu deze
    koppeling aan</a>'
  image: "/v1622801300/dationlogo_vmmwuz.png"
  zooming: true
...
- content: 'Stel je voor: van elk telefoontje wat binnenkomt bij jouw bedrijf zie
    ...
    noemen wij Bubble. Met 1 klik open je Dation Rijlesplanner met de juiste gegevens en kun je
  ...
  zooming: true
  position: image_left
  title: 'Integratie telefonie en Dation Rijlesplanner: maak kennis met onze slimme pop-up'
  image_position: center
textblocks:
