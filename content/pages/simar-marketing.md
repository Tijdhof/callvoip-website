---
title: Simar CRM + slimme telefonie
description: 'Integratie van het CRM Simar en onze telefonie: makkelijk, snel en efficiënt'
type: page
layout: default2
logos: false
url: "/crmintegratie/Simar/"
marketplaceItem: true
hero:
  title: Simar + slimme telefonie
  content: '<div class="usp-list"><ul><li>Slimme pop-up van elk gesprek</li><li>Direct
    de klantgegevens in beeld</li><li>Werk efficiënter</li></ul></div>Het CRM platform Simar is een systeem gericht op de keuken, sanitair en tegelbranche. Meer specifiek op excellente communicatie met hun klanten. Email, chat, Whatsapp en natuurlijk hoort daar ook telefonie bij! En daar komt Callvoip om de hoek kijken: koppel jouw Simar nu aan onze telefonie en profiteer van het gemak en de efficiëntie.<br><br><a
    href="https://www.callvoip.nl/aanvragen/voip-cti/" class="button">Vraag nu deze
    koppeling aan</a>'
  image: "/v1622801300/simarlogo_b3klgs.png"
  zooming: true
...
- content: 'Stel je voor: van elk telefoontje wat binnenkomt bij jouw bedrijf zie
    ...
    noemen wij Bubble. Met 1 klik open je Simar met de juiste gegevens en kun je
  ...
  zooming: true
  position: image_left
  title: 'Integratie telefonie en Simar: maak kennis met onze slimme pop-up'
  image_position: center
textblocks:
