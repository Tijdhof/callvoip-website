---
title: Sherpaan CRM + slimme telefonie
description: 'Integratie van het CRM Sherpaan en onze telefonie: makkelijk, snel en efficiënt'
type: page
layout: default2
logos: false
url: "/crmintegratie/Sherpaan/"
marketplaceItem: true
hero:
  title: Sherpaan + slimme telefonie
  content: '<div class="usp-list"><ul><li>Slimme pop-up van elk gesprek</li><li>Direct
    de klantgegevens in beeld</li><li>Werk efficiënter</li></ul></div>Het CRM platform Sherpaan is een systeem gericht op Webshop Software. Meer specifiek op excellente communicatie met hun klanten. Email, chat, Whatsapp en natuurlijk hoort daar ook telefonie bij! En daar komt Callvoip om de hoek kijken: koppel jouw Sherpaan nu aan onze telefonie en profiteer van het gemak en de efficiëntie.<br><br><a
    href="https://www.callvoip.nl/aanvragen/voip-cti/" class="button">Vraag nu deze
    koppeling aan</a>'
  image: "/v1622801300/sherpaanlogo_t7xigi.png"
  zooming: true
...
- content: 'Stel je voor: van elk telefoontje wat binnenkomt bij jouw bedrijf zie
    ...
    noemen wij Bubble. Met 1 klik open je Sherpaan met de juiste gegevens en kun je
  ...
  zooming: true
  position: image_left
  title: 'Integratie telefonie en Sherpaan: maak kennis met onze slimme pop-up'
  image_position: center
textblocks:
